...
$thefirstsessionid=session_id();
$getdetailsofsession=mysql_query("SELECT USERID FROM $SET_THEMYSQLLOGINTABLENAME WHERE 'SESSIONID'='$thefirstsessionid'");
$thefetcheduserid=mysql_fetch_array($getdetailsofsession);
$theextracteduseridis=$thefetcheduserid['USERID'];
