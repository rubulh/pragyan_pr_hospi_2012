...
<div id="page">
	<div id="box1">
<p>
<form method="POST" action="loginhandler.php" id="theloginform">
<input type="email" id="emaillogin" value="emailid here" size="50" name="emailidpost">
<br>
<input type="password" id="password" value="emailid here" size="50" name="pass">
<br>
<input type="submit" value="checkin" id="checkinbutton" name="submitted">
</form>
</p>
	</div>
