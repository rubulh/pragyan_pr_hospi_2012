...
<div id="page">
	<div id="box1">
<p>
<input type="email" id="emailcheckin" value="emailid here" size="50">
<input type="button" value="checkin" id="checkinbutton">
</p>
	</div>
<script>
var thejsonfortest;
$(document).ready(function(){
                             ...
                             $("#checkinbutton").click(function(){
                                                                   var emailtobe=$("#emailcheckin").attr("value");
                                                                   var sendstring="email="+emailtobe+"";
                                                                    $.ajax({
                                                                            type:"POST",url:"checkoutemailsearch.php",data:sendstring,success:function(html1)
                                                                     {
                                                                      thejsonfortest=html1;
                                                                      html=eval(html1);
                                                                      $("#splash").html("");
if(html[0] && html[1] && html[2] && html[3])
					{			     var printstring="EMAIL="+html[0]+"<br>NAME="+html[1]+"<br>phone="+html[2]+"<br>college="+html[3]+"<br>checkin<br>checkout<br>";}
else if(html[0]="NOT")
{
var printstring="THE USER DOES NOT EXIST";
}
else if(html[0]="OUT")
{
var printstring="THE USER HAS ALREADY CHECKED OUT";
}

                                                                      $("#splash").append(printstring);
